...
public class Assignment_3_3 {
	 ...
	 *  followed by 8%, 7% and 9%. Hints: using method override.*/
...
class ChaseBank extends Assignment_3_3{
	void displayInterestRate(){
		System.out.println("Chase Bank interst rate is 8%");
		}
}

class CityBank extends Assignment_3_3{
	void displayInterestRate(){
		System.out.println("City Bank interst rate is 7%");
	}
}
	
		class TDBank extends Assignment_3_3{
			void displayInterestRate(){
				System.out.println("TD Bank interst rate is 9%");
}
		}
